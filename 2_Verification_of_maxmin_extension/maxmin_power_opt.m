clear;
close all;
load('L1channels.mat','Hab','Hac','Hbc','Ha2b2','Ha2c','Hb2c','Ha2a','Ha2b','Hb2a','Hb2b','L','N','sigma_ab','sigma_c','sigma_loop');
...
w_sdp = irs_optimization_maxmin_iter(L, Pmin, Pmax, Pa,Pb,Pa2,Pb2,Hab(:,r),Hac(:,r),Hbc(:,r),Ha2b2(:,r),Ha2c(:,r),Hb2c(:,r),Ha2a(:,r),Ha2b(:,r),Hb2a(:,r),Hb2b(:,r),sigma_ab,sigma_loop,sigma_c,[w;1]);
[minrate_sdp,~,~] = min_secrecy_rate(Hab(:,r),Hac(:,r),Hbc(:,r),Ha2b2(:,r),Ha2c(:,r),Hb2c(:,r),Ha2a(:,r),Ha2b(:,r),Hb2a(:,r),Hb2b(:,r),Pa,Pb,Pa2,Pb2,w_sdp(1:end-1),sigma_ab,sigma_loop,sigma_c);
[minrate_rand,~,~] = min_secrecy_rate(Hab(:,r),Hac(:,r),Hbc(:,r),Ha2b2(:,r),Ha2c(:,r),Hb2c(:,r),Ha2a(:,r),Ha2b(:,r),Hb2a(:,r),Hb2b(:,r),Pa,Pb,Pa2,Pb2,wrand,sigma_ab,sigma_loop,sigma_c);
