...
coords = [-51.19 61.90;-11.20 61.29; 50.13 76.03;31.56 40.60; 0.00 97.50;0.00 -97.50];
...
save(string(2)+'_pairs_'+string(10)+'_seeds_'+string(1)+'_trial.mat','L_list','min_master_list','min_leaked_master_list','min_inf_master_list')
