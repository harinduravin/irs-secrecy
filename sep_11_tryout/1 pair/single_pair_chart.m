...
coords = [-51.19 61.90;-11.20 61.29;0.00 97.50;0.00 -97.50]; 
...
save(string(1)+'_pairs_'+string(10)+'_seeds_'+string(1)+'_trial.mat','L_list','min_master_list','min_leaked_master_list')
