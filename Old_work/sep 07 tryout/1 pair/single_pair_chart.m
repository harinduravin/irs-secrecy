...
coords = [20.54 -23.17;-13.80 -2.65;0.00 97.50;0.00 -97.50;
];
                ...
                try
                    ...
                    subject to
                        ...
                        for u = 1:length(user_list)
                            ...
                            20+log(real(trace(remove_small(get_cvx_leg_inf(user_list(u),P_hat))*X))+sigma_ab+sigma_loop) +log(real(trace(remove_small(get_cvx_eve_inf(user_list(u),P_hat))*X)) +sigma_c)+get_S(user_list(u),P_hat) + real(trace(remove_small(get_grad_S(user_list(u),P_hat,W))*(X-remove_small(W)))) >= t;
                        end
...
save(string(1)+'_pairs_'+string(15)+'_seeds_'+string(1)+'_trial.mat','L_list','min_master_list','min_leaked_master_list')
