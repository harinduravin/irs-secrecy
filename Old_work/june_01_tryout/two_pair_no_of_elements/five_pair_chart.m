            ...
            try
                ...
                subject to
                    ...
                    for u = 1:length(user_list)
                        ...
                        % for n = 5
                        20-log(sigma_ab + sigma_loop + P(p_(user_list(u),1,1))*H_(user_list(u),1,1)+ P(p_(user_list(u),1,2))*H_(user_list(u),1,2) + P(p_(user_list(u),1,3))*H_(user_list(u),1,3)+ P(p_(user_list(u),1,4))*H_(user_list(u),1,4)+ P(p_(user_list(u),1,5))*H_(user_list(u),1,5) + P(p_(user_list(u),1,6))*H_(user_list(u),1,6)+ P(p_(user_list(u),1,7))*H_(user_list(u),1,7)+ P(p_(user_list(u),1,8))*H_(user_list(u),1,8) + P(p_(user_list(u),1,9))*H_(user_list(u),1,9))...
...
plot(L_list,mean_user_rates(:,6)','DisplayName','B4');
plot(L_list,mean_user_rates(:,7)','DisplayName','A4');
plot(L_list,mean_user_rates(:,8)','DisplayName','B4');
plot(L_list,mean_user_rates(:,9)','DisplayName','A5');
plot(L_list,mean_user_rates(:,10)','DisplayName','B5');
ylim([-1 4])
