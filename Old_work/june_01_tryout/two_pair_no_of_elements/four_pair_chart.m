...
77.36 35.80;89.39 73.95;0.00 97.50;0.00 -97.50];
            ...
            try
                ...
                subject to
                    ...
                    for u = 1:length(user_list)
                        ...
                        % for n = 4
                        20-log(sigma_ab + sigma_loop + P(p_(user_list(u),1,1))*H_(user_list(u),1,1)+ P(p_(user_list(u),1,2))*H_(user_list(u),1,2) + P(p_(user_list(u),1,3))*H_(user_list(u),1,3)+ P(p_(user_list(u),1,4))*H_(user_list(u),1,4)+ P(p_(user_list(u),1,5))*H_(user_list(u),1,5) + P(p_(user_list(u),1,6))*H_(user_list(u),1,6)+ P(p_(user_list(u),1,7))*H_(user_list(u),1,7))...
