...
-60.15 7.59;-23.08 -7.43; -85.14 -38.49;-88.72 -78.33; 0.00 97.50;0.00 -97.50]; 
...
save(string(5)+'_pairs_'+string(10)+'_seeds_'+string(1)+'_trial.mat','L_list','min_master_list','min_leaked_master_list','min_inf_master_list')
