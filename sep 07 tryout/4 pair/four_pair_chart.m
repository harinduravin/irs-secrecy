...
24.58 52.39;61.41 68.00;0.00 97.50;0.00 -97.50;
];
...
save(string(4)+'_pairs_'+string(15)+'_seeds_'+string(1)+'_trial.mat','L_list','min_master_list','min_leaked_master_list','min_inf_master_list')
