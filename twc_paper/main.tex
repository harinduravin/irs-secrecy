...
\author{Author name,~\IEEEmembership{Staff,~IEEE,}
        % <-this % stops a space
...
%State the background -> state recent development -> Directly address the issue 
%
%then establish ; Your investigation is important to resolve the issue and improve technology
%
%Avoid criticism of previous work. don't use very old or many old reference.
%
%Fair , fatless and fascinating
