...
77.36 35.80;89.39 73.95;0.00 97.50;0.00 0.00];
...
save(string(4)+'_pairs_'+string(20)+'_seeds_'+string(2)+'_trial.mat','L_list','min_master_list','min_leaked_master_list','min_inf_master_list')
