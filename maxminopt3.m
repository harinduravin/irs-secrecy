...
HAA = get_H(11.88,13.47,21.53,lambda,L,Lo,pl);
HBB = get_H(11.97,14.02,22.50,lambda,L,Lo,pl);
H11 = get_H(11.88,11.97,3.59,lambda,L,Lo,pl);
 H21 = get_H(13.47,11.97,19.35,lambda,L,Lo,pl);
H12 = get_H(11.88,14.02,24.12,lambda,L,Lo,pl);
H22 = get_H(13.47,14.02,5.01,lambda,L,Lo,pl);
HA1C = get_H(11.88,28.10,27.81,lambda,L,Lo,pl);
HA2C = get_H(13.47,28.10,19.74,lambda,L,Lo,pl);
HB1C = get_H(11.97,28.10,24.22,lambda,L,Lo,pl);
HB2C = get_H(14.02,28.10,24.51,lambda,L,Lo,pl);
...
%     rice_channel = sqrt(1/32)*(randn(L,1)+1i*randn(L,1)) + sqrt(30/32)*exp(1i*2*pi*(dist/wave_l-floor(dist/wave_l)));
% end
% 
